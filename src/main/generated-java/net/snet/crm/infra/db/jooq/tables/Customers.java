...
import net.snet.crm.infra.db.jooq.Indexes;
import net.snet.crm.infra.db.jooq.Keys;
...
public class Customers extends TableImpl<CustomersRecord> {
    ...
    private static final long serialVersionUID = 995422698;
     ...
     */
    public final TableField<CustomersRecord, String> SUPPLEMENTARY_NAME = createField(DSL.name("supplementary_name"), org.jooq.impl.SQLDataType.VARCHAR(40), this, "");
